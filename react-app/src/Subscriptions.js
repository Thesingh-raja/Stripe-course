      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className="well">
          ...
          <button
            className={
              'btn ' +
              (plan === 'price_1KYr8HSFFkjxlqDs24MQt6Q2'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1KYr8HSFFkjxlqDs24MQt6Q2')}>
            Choose Monthly Rs 300/m
          </button>

          <button
            className={
              'btn ' +
              (plan === 'price_1KYr8gSFFkjxlqDsX10lCKeW'
                ? 'btn-primary'
                : 'btn-outline-primary')
            }
            onClick={() => setPlan('price_1KYr8gSFFkjxlqDsX10lCKeW')}>
            Choose Quarterly Rs 250/q
          </button>
